...
public final class GameEntities {
	...
	private static final Set<UnorderedPair<Class<? extends GameEntity>, Class<? extends GameEntity>>> COLLISION_PAIR_SET
			...
			UnorderedPair.immutableOf(Bush.class, CardboardBoxTower.class),
	...
	private static final Set<Pair<Class<? extends EffectEntity>, Class<? extends LivingEntity>>> EFFECT_LIVING_SET
			...
			Pair.immutableOf(NyanCatBullet.class, NormalEnemy.class),
			Pair.immutableOf(NyanCatBullet.class, NormalAircraft.class),
			Pair.immutableOf(NyanCatBullet.class, BigAircraft.class),
			Pair.immutableOf(NyanCatBullet.class, Tanker.class),
			...
			Pair.immutableOf(NyanCatBullet.class, JohnCenaBossEnemy.class),
			...
			Pair.immutableOf(NyanCatBullet.class, BinLadenBossEnemy.class),
			...
			Pair.immutableOf(NyanCatBullet.class, KimJongUnBossEnemy.class),
			...
			Pair.immutableOf(NyanCatBullet.class, SonGokuBossEnemy.class),
			...
			Pair.immutableOf(NyanCatBullet.class, ElonMuskBossEnemy.class),
			...
			Pair.immutableOf(NyanCatBullet.class, MedicBossEnemy.class),
