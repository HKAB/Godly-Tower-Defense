...
import mrmathami.thegame.entity.enemy.boss.KimJongUnBossEnemy;
...
public class KimJongUnBossSpawner extends AbstractSpawner<KimJongUnBossEnemy> {
    public KimJongUnBossSpawner(long createdTick, long posX, long posY, long width, long height, long spawnInterval, long initialDelay, long numOfSpawn) {
        super(createdTick, posX, posY, width, height, Config.KIM_JONG_UN_BOSS_ENEMY_SIZE, KimJongUnBossEnemy.class, Config.KIM_JONG_UN_BOSS_ENEMY_GID, spawnInterval, initialDelay + new Random().nextInt(100), numOfSpawn);
    }
