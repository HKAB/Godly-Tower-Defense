...
public final class MachineGunBullet extends AbstractBullet {
    public MachineGunBullet(long createdTick, double posX, double posY, double deltaX, double deltaY, AbstractEnemy enemyTarget) {
        super(createdTick, posX, posY, deltaX, deltaY, 64, 64, Config.MACHINE_GUN_BULLET_SPEED, Config.MACHINE_GUN_BULLET_STRENGTH, Config.MACHINE_GUN_BULLET_TTL, Config.MACHINE_GUN_BULLET_GID, enemyTarget);
    }
}
