...
public final class GameUI {
    ...
    public GameUI() {
        NormalButton button = new NormalButton(0, 150, 150, 64, 64, "/bar/button/button_home");
        NormalButton dragable = new NormalButton(0, 600, 150, 64, 64, "/bar/button/button_play");
