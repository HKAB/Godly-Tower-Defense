...
public final class RocketLauncherTowerDrawer implements EntityDrawer {
    ...
    public void draw(long tickCount, @Nonnull GraphicsContext graphicsContext, @Nonnull GameEntity entity,
        ...
        WritableImage rocketLauncherImage = new WritableImage(reader,
                (((RocketLauncherTower)entity).getGID() - 1) % maxTileWidth * (int)screenWidth,
                Math.round((((RocketLauncherTower)entity).getGID() - 1) / maxTileWidth) * (int)screenHeight,
