...
public class MPPopup extends AbstractPopup {
    ...
    public MPPopup(long createdTick, double posX, double posY, double width, double height, StackPane stackPane) {
        ...
        PopupButton closeButton = new PopupButton(0, 0, 0, (Config.SCREEN_WIDTH - posX - 10)/Config.TILE_SIZE, (posY + 10)/Config.TILE_SIZE, 20, "X");
        getPopupEntities().add(closeButton);
        getPopupEntities().add(popupIPInput);
        getPopupEntities().add(popupPortInput);
        PopupButton clientButton =  new PopupButton(0, 0, 0, (Config.SCREEN_WIDTH/2.0 + 150)/Config.TILE_SIZE, (Config.SCREEN_HEIGHT/2.0 + 60)/Config.TILE_SIZE, 20, "CL");
        getPopupEntities().add(clientButton);
        PopupButton serverButton = new PopupButton(0, 0, 0, (Config.SCREEN_WIDTH/2.0 + 150 - 20*2 - 10)/Config.TILE_SIZE, (Config.SCREEN_HEIGHT/2.0 + 60)/Config.TILE_SIZE, 20, "SE");
