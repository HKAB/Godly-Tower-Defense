...
public class MPPopup extends AbstractPopup {
    ...
    public MPPopup(long createdTick, double posX, double posY, double width, double height, StackPane stackPane) {
        ...
        getPopupEntities().add(new PopupLabel(0, (Config.SCREEN_WIDTH/2.0 - 150 - 110)/Config.TILE_SIZE, (Config.SCREEN_HEIGHT/2.0 - 60 + 35)/Config.TILE_SIZE, 27, "IP ADDRESS"));
        getPopupEntities().add(new PopupLabel(0,  (Config.SCREEN_WIDTH/2.0 - 150 - 60)/Config.TILE_SIZE, (Config.SCREEN_HEIGHT/2.0 + 35)/Config.TILE_SIZE, 30, "PORT"));
