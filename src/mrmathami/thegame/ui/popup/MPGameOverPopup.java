...
public class MPGameOverPopup extends AbstractPopup implements CanControlGame {
    ...
    public MPGameOverPopup(long createdTick, double posX, double posY, double width, double height, StackPane stackPane) {
        ...
        getPopupComponents().add(new PopupLabel(0, (width/2.0)/Config.TILE_SIZE, (height/2.0 + 125)/Config.TILE_SIZE, 100, Color.BLACK, "GAME OVER"));
        getPopupComponents().add(new PopupImage(0, (width/2.0)/Config.TILE_SIZE, (height/2.0 - 256)/Config.TILE_SIZE, "res/stage/popup/images/sad.png"));
