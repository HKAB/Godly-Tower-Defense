...
public class GameOverPopup extends AbstractPopup implements CanControlGame {
    ...
    public GameOverPopup(long createdTick, double posX, double posY, double width, double height, StackPane stackPane) {
        ...
        getPopupComponents().add(new PopupLabel(0, (Config.SCREEN_WIDTH/2.0)/Config.TILE_SIZE, (Config.SCREEN_HEIGHT/2.0 + 125)/Config.TILE_SIZE, 100, Color.BLACK, "GAME OVER"));
        getPopupComponents().add(new PopupImage(0, (Config.SCREEN_WIDTH/2.0)/Config.TILE_SIZE, (Config.SCREEN_HEIGHT/2.0 - 256)/Config.TILE_SIZE, "res/stage/popup/images/sad.png"));
